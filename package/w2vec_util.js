 ...
 (function(global){   
    ...
    function gen_word(window=5, text_list,stopwords){
        ...
        for(let index in text_list){
            ...
            let text_clean = clean(text,stopwords);
    ...
    function create_data(word_list,unique_dict,n_words){
    ...
    global.gen_word = gen_word
    global.unique_word = unique_word
    global.obj_len = obj_len
    global.create_data = create_data

})(word_utils)

module.exports = word_utils;